...
INSERT INTO "new_contracts" ("account_name", "approver_id", "bank_name", "confidentiality", "contract_number", "created_at", "customer_contact_email", "customer_contact_name", "customer_contact_phone", "customer_contact_title", "dispute_resolution", "drafter_id", "end_date", "estimated_value", "id", "is_active", "liability", "opportunity_id", "payment_account", "payment_terms", "payment_terms_details", "penalties", "risk_assessment", "scope", "sla", "special_terms", "start_date", "status", "total_contract_value", "vendor_contact_name", "vendor_contact_phone", "vendor_name", "warranty", "won_price") SELECT "account_name", "approver_id", "bank_name", "confidentiality", "contract_number", "created_at", "customer_contact_email", "customer_contact_name", "customer_contact_phone", "customer_contact_title", "dispute_resolution", "drafter_id", "end_date", "estimated_value", "id", "is_active", "liability", "opportunity_id", "payment_account", "payment_terms", "payment_terms_details", "penalties", "risk_assessment", "scope", "sla", "special_terms", "start_date", "status", "total_contract_value", "vendor_contact_name", "vendor_contact_phone", "vendor_name", "warranty", "won_price" FROM "contracts";
